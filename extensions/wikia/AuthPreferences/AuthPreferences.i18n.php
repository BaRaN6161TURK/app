...
$messages['pl'] = array(
	...
	'fbconnect-disconnect-account-link' => 'Twoje konto na portalu FANDOM jest obecnie połączone z Facebookiem. Możesz zawsze [[#|odłączyć]] swoje konto FANDOM od Facebooka. Jeżeli to zrobisz, dalej będzie można korzystać z konta na Fandomie, a twoja historia (edycje, punkty, odznaczenia) pozostanie bez zmian.',
	'fbconnect-error-fb-account-in-use' => 'To konto Facebooka jest już połączone z innym kontem na portalu FANDOM. Spróbuj dołączyć inne konto lub zaloguj się do Facebooka i odłącz obecne konto zanim połączysz je z kontem $1.',
	'fbconnect-preferences-connected' => 'Gratulacje! Twoje konta na portalu FANDOM i Facebooku zostały połączone.',
	'fbconnect-preferences-connected-error' => 'Przykro nam, nie mogliśmy wykonać połączenia. Upewnij się, że {{GENDER:|zalogowałeś|zalogowałaś}} się do konta FANDOM i posiadasz dostęp, aby połączyć konto FANDOM z Facebookiem.',
	...
	'google-connect-unknown-error' => 'Przykro nam, nie mogliśmy połączyć kont. Upewnij się, że {{GENDER:|zalogowałeś|zalogowałaś}} się do konta FANDOM i {{GENDER:|wyraziłeś|wyraziłaś}} zgodę, aby FANDOM połączył się z Google.',
...
$messages['ru'] = array(
	...
	'fbconnect-disconnect-account-link' => 'Ваша учётная запись на ФЭНДОМЕ подключена к Facebook. Вы можете её [[#|отключить]] и продолжать использовать ФЭНДОМ как обычно. При этом история ваших действий (правки, достижения) останется без изменений.',
	'fbconnect-error-fb-account-in-use' => 'Этот аккаунт на Facebook уже подключён к учётной записи другого участника на ФЭНДОМЕ. Пожалуйста, подключите другой аккаунт или войдите в свою учётную запись на ФЭНДОМЕ через Facebook и отключите её, чтобы соединить этот аккаунт на Facebook с учётной записью $1.',
	'fbconnect-preferences-connected' => 'Вы подключили учётную запись ФЭНДОМА к Facebook.',
	'fbconnect-preferences-connected-error' => 'Мы сожалеем, но подключение завершить не удалось. Убедитесь, что вы вошли в свою учётную запись ФЭНДОМА и дали разрешение связать её с вашим аккаунтом на Facebook.',
	'prefs-auth-prefstext' => 'Аккаунт и соц. сети',
	'google-connect-account-connected' => 'Поздравляем! Вы подключили вашу учётную запись на ФЭНДОМЕ к аккаунту Google.',
	...
	'prefs-auth-connections-prefstext' => 'Статус',
